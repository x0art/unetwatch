...
export type TimeRange = "1h" | "24h" | "3d" | "7d" | "30d" | "90d" | "1y"
...
function readInitialTimeRange(): TimeRange {
  ...
  try {
    ...
    if (q === "1h" || q === "24h" || q === "3d" || q === "7d" || q === "30d" || q === "90d" || q === "1y") return q
  } catch {
    /* ignore */
  }
  try {
    const stored = window.localStorage.getItem(TIME_RANGE_KEY)
    if (stored === "1h" || stored === "24h" || stored === "3d" || stored === "7d" || stored === "30d" || stored === "90d" || stored === "1y") return stored
  } catch {
    /* ignore */
  }
  return "24h"
  ...
  useEffect(() => {
    ...
    const onPop = () => {
      try {
        ...
        if (r === "1h" || r === "24h" || r === "3d" || r === "7d" || r === "30d" || r === "90d" || r === "1y") setTimeRangeRaw(r)
